...
if ($magic_elementor_lite_blog_style == 'grid' && !is_single()) :
	get_template_part('template-parts/content', 'grid');
elseif ($magic_elementor_lite_blog_style == 'list' && !is_single()) :
			...
			<div class="xpost-text">
				...
				<div class="entry-content">
					...
					if (is_single()) {
						the_content(
							sprintf(
								wp_kses(
									...
									__('Continue reading<span class="screen-reader-text"> "%s"</span>', 'magic-elementor-lite'),
									array(
										'span' => array(
											'class' => array(),
										),
						...
						wp_link_pages(
							array(
								'before' => '<div class="page-links">' . esc_html__('Pages:', 'magic-elementor-lite'),
								'after'  => '</div>',
							)
						);
					} else {
